 ...
 * @author Benjamin
 */
public class InputGUICsvWriter extends javax.swing.JFrame {

    private String EMPTY_STRING = "";
    private String COMMA = ",";
    private String filePath = "F:/Advanced Java/Temp/ContactList.csv";
    private int ZERO = 0;
    
    /**
     * Creates new form InputGUICustomWriter
     */
    public InputGUICsvWriter() {
        initComponents();
    }
    ...
    private void btnEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnterActionPerformed
        try {
            ...
            String lastName = txtLastName.getText() + COMMA;
            String firstName = txtFirstName.getText() + COMMA;
            String address = txtAddress.getText() + COMMA;
            String city = txtCity.getText() + COMMA;
            String state = txtState.getText() + COMMA;
            String zipCode = txtZip.getText() + COMMA;
            String email = txtEmail.getText() + COMMA;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InputGUICsvWriter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InputGUICsvWriter().setVisible(true);
            }
        });
    }
